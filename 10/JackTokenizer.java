...
public class JackTokenizer {
    ...
    static {
        ...
        keyWordMap.put("class",CLASS);keyWordMap.put("constructor",CONSTRUCTOR);
    ...
    **/
    ...
    //Iniciamos las expresiones regulares
    ...
    //Obtiene el siguiente token de la entrada y lo convierte en el token actua
    ...
    public void advance(){
        ...
        if (hasMoreTokens()) {
            ...
            throw new IllegalStateException("No hay tokens");
        }
        ...
        if (currentToken.matches(keyWordReg)){
            ...
            throw new IllegalArgumentException("No se encontro el token:" + currentToken);
        }
    ...
    /**
      * Retorna el tipo de estado el Token
     */
    ...
    //Devuelve la palabra clave es cuando tokenType () es KEYWOR
    public int keyWord(){
        ...
        if (currentTokenType == KEYWORD){
            ...
            throw new IllegalStateException("Actual token no es una keyword!");
        }
    }
    //Retorna el caracter actual en la clase
    public char symbol(){
        ...
        if (currentTokenType == SYMBOL){
            ...
            throw new IllegalStateException(" token no es un symbol!");
        }
    }
    //Devuelve el keyword  que es el token actual
    public String identifier(){
        ...
        if (currentTokenType == IDENTIFIER){
            ...
            throw new IllegalStateException("Actual token no es un identifier!");
        }
    }
    //Retorna el entero actual del token
    public int intVal(){
        ...
        if(currentTokenType == INT_CONST){
            ...
            throw new IllegalStateException("Actual token no es un integer ");
        }
    }
    //Retorna la string actual del token
    public String stringVal(){
        ...
        if (currentTokenType == STRING_CONST){
            ...
            throw new IllegalStateException("Actual token no es una string");
        }
    }
   ...
   //Elimina los espacio en el string
    ...
    //Elimina los bloques de comando 
